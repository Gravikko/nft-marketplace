...
contract StakingViewsTest is StakingTestHelper {
    function test_GetUserStakedTokens() public {
        ...
        uint256[] memory stakedTokens = staking.getUserTokenStaked(USER1, collectionId);
    ...
    function test_CheckUserStakeNFT_InvalidCollectionId() public {
        ...
        vm.expectRevert();
        staking.checkUserStakeNFT(USER1, invalidCollectionId, tokenId);
    }
    ...
    function test_GetUserTokenStaked_InvalidCollectionId() public {
        ...
        vm.expectRevert();
        staking.getUserTokenStaked(USER1, invalidCollectionId);
    }
