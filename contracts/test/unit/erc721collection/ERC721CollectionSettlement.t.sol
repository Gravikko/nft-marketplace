...
contract ERC721CollectionSettlementTest is ERC721CollectionHelper {
    ...
    function test_Initialize() public {
        ERC721Collection.InitConfig memory config = erc721Collection.getERC721CollectionSettings();
    ...
    function test_RevertWhen_Initialize() public {
        ...
        ERC721Collection.InitConfig memory config2 = erc721Collection.getERC721CollectionSettings();
    ...
    function test_SetNewDefaultRoyaltyInfo() public {
        ...
        erc721Collection.setNewDefaultRoyaltyInfo(newReceiver, newFee);
    ...
    function test_RevertWhen_SetNewDefaultRoyaltyInfo() public {
        vm.expectRevert(ERC721Collection.ZeroAddress.selector);
        erc721Collection.setNewDefaultRoyaltyInfo(address(0), DEFAULT_ROYALTY_FEE);
    }
    ...
    function test_DelayedReveal() public {
        ...
        assertEq(erc721Collection.getVrfPendingReveals(tokenId), true);
        ...
        assertEq(erc721Collection.getVrfPendingReveals(tokenId), false);
        assertEq(erc721Collection.isRevealed(tokenId), true);
    }
    ...
    function test_RevertWhen_DelayedReveal() public {
        ...
        ERC721Collection.InitConfig memory config3 = erc721Collection.getERC721CollectionSettings();
