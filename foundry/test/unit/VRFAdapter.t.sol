...
contract VRFAdapterTest is BaseTest { 
    ...
    function test_Initialize() public { 
        assertEq(address(vrfAdapter.vrfCoordinator()), address(mockCoordinator));
    }
    ...
    function test_setVRFConfig() public {
        ...
        assertEq(address(vrfAdapter.vrfCoordinator()), newCoordinator);
    }
    ...
    function test_RevertWhen_requestRandomness_VRFNotConfigured() public {
        ...
        uint256 slot = stdstore.target(address(vrfAdapter)).sig("vrfCoordinator()").find();
